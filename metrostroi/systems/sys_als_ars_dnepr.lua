...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("ALS_ARS_D")
...
function TRAIN_SYSTEM:Think(dT)
    ...
    local EnableALS = ((S["GE"]+self.ALS)--[[ *Train.KPK1.Value*Train.ALS.Value+(1-Train.KPK2.Value)--]] )*Train.FMM1.Value*(1-Train.UPPS_K1.Value)
    ...
    Train:WriteTrainWire(83,S["AR60"])
    Train:WriteTrainWire(82,S["AR40"])
    Train:WriteTrainWire(81,S["AR0"])
    Train:WriteTrainWire(80,S["AR04"])
    Train:WriteTrainWire(86,self.GE*Train.BUM_KPP.Value)
    --LN 1/5 Original
    ...
    Panel.AR60 = Train:ReadTrainWire(83)
    Panel.AR40 = Train:ReadTrainWire(82)
    Panel.AR0  = Train:ReadTrainWire(81)
    Panel.AR04 = Train:ReadTrainWire(80)
    Panel.KT = Train:ReadTrainWire(86)
    --LN 1/5 Original
    --Panel.LN = S["GE"]*Train.NG.Value+Train:ReadTrainWire(89)*Train.FMM1.Value
    --LN 1/5 Fix
    Panel.LN = S["GE"]*Train.NG.Value*Train.PD1.Value+Train:ReadTrainWire(89)*Train.FMM1.Value
