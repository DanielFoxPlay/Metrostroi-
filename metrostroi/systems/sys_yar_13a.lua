...
function TRAIN_SYSTEM:Initialize()
    ...
    self.Train:LoadSystem("RV2","Relay","RM3100",{ open_time = 1,bass=true })
...
function TRAIN_SYSTEM:Think()
    ...
    self.RUTTarget = 250 + 100*Train.RUTavt*self.Train.Pneumatic.WeightLoadRatio+70*Train.RUTreg
    if Train.RUTpod > 0.5
