...
Metrostroi.AddLastStationTex("702",909,"models/metrostroi_schemes/destination_table_black/label_mezhdunarodnaya")
Metrostroi.AddLastStationTex("702",914,"models/metrostroi_schemes/destination_table_black/label_oktyabrskaya")
Metrostroi.AddLastStationTex("702",915,"models/metrostroi_schemes/destination_table_black/label_rechnaya")
Metrostroi.AddLastStationTex("702",916,"models/metrostroi_schemes/destination_table_black/label_proletarskaya")
Metrostroi.AddLastStationTex("710",909,"models/metrostroi_schemes/destination_table_white/label_mezhdunarodnaya")
Metrostroi.AddLastStationTex("710",914,"models/metrostroi_schemes/destination_table_white/label_oktyabrskaya")
Metrostroi.AddLastStationTex("710",915,"models/metrostroi_schemes/destination_table_white/label_rechnaya")
Metrostroi.AddLastStationTex("710",916,"models/metrostroi_schemes/destination_table_white/label_proletarskaya")
Metrostroi.AddLastStationTex("717",909,"models/metrostroi_schemes/destination_table_white/label_mezhdunarodnaya")
Metrostroi.AddLastStationTex("717",914,"models/metrostroi_schemes/destination_table_white/label_oktyabrskaya")
Metrostroi.AddLastStationTex("717",915,"models/metrostroi_schemes/destination_table_white/label_rechnaya")
Metrostroi.AddLastStationTex("717",916,"models/metrostroi_schemes/destination_table_white/label_proletarskaya")
Metrostroi.AddLastStationTex("720",909,"models/metrostroi_schemes/destination_table_white/label_mezhdunarodnaya")
Metrostroi.AddLastStationTex("720",914,"models/metrostroi_schemes/destination_table_white/label_oktyabrskaya")
Metrostroi.AddLastStationTex("720",915,"models/metrostroi_schemes/destination_table_white/label_rechnaya")
Metrostroi.AddLastStationTex("720",916,"models/metrostroi_schemes/destination_table_white/label_proletarskaya")
...
Metrostroi.AddANSPAnnouncer("ASNP Boiko + Pyaseckaya",{
    ...
    { --МАРШРУТ
        ...
        },
        {
            ...
            dep = {nil,{"doors_closing_m","oktyabrskaya_next_m",0.2}},
...
Metrostroi.AddANSPAnnouncer("RIU Boiko + Pyaseckaya",{
    ...
    { --МАРШРУТ
        ...
        BlockDoors = true,
        {
            909,"Международная","Mezhdunarod.",
            arrlast = {nil,{"arr_mejdunarodnaya_f",0.5,"last_f",2,"things_f",2,"deadlock_f"},"mejdunarodnaya_m"},
            dep = {{"doors_closing_m","park_kultury_m"}},
        },
        {
            910,"Парк Культуры","Park Kultury",
            arr = {{"station_m","park_kultury_m"},"arr_park_kultury_f"},
            dep = {{"doors_closing_m","politehnicheskaya_next_m",0.2,"politeness_m"},{"doors_closing_f","next_mejdunarodnaya_f",0.2,"politeness_f"}},
            not_last_c = {nil,"not_last_f"}
        },
        {
            911,"Политехнич.","Politehnich.",
            arr = {{"station_m","politehnicheskaya_arr_m",0.2,"things_m"},{"arr_politehnicheskaya_f",0.2,"objects_f"}},
            dep = {{"doors_closing_m","prospekt_suvorova_m"},{"doors_closing_f","next_park_kultury_f"}},
            not_last_c = {nil,"not_last_f"}
        },
        {
            912,"Пр. Суворова","Pr. Suvorova",
            arr = {{"station_m","prospekt_suvorova_m",0.2,"objects_m"},{"station_m","prospekt_suvorova_m",0.2,"things_m"}},
            dep = {{"doors_closing_m","nahimovskaya_m"},{"doors_closing_m","politehnicheskaya_m"}},
            not_last_c = {nil,"not_last_f"}
        },
        {
            913,"Нахимовская","Nahimovskaya",
            arr = {"arr_nahimovskaya_f",{"station_m","nahimovskaya_m"}},
            dep = {{"doors_closing_f","next_oktyabrskaya_f",0.2,"politeness_f"},{"doors_closing_m","prospekt_suvorova_m"}},
            not_last_c = {"not_last_f"}
        },
        {
            914,"Октябрьская","Oktabrskaya",
            arr = {"arr_oktyabrskaya_f",{"station_m","oktyabrskaya_arr_m",0.2,"exit_m"}},
            dep = {{"doors_closing_f","next_rechnaya_f","spec_rechnaya_doors_f"},{"doors_closing_m","nahimovskaya_m"}},
            arrlast = {{"arr_oktyabrskaya_f",0.5,"last_f",2,"things_f",2,"deadlock_f"},{"station","oktyabrskaya_arr_m",0.5,"last_m",2,"things_m",2,"deadlock_m"},"oktyabrskaya_next_m"},
            not_last_c = {"not_last_f"},
...
Metrostroi.SetRRIAnnouncer({
...
},{
    {
        ...
        },
        {
            ...
            dep = {nil,{"next_oktyabrskaya",0.2,"politeness"}},
...
Metrostroi.SetUPOAnnouncer({
...
},{
    {
        ...
        noises = {2,3},noiserandom = 0.08,dist=20,
    },
    {
        910,"Парк Культуры",
        ...
        noises = {1,2},noiserandom = 0.12,dist=20,
    },
    {
        911,"Политехническая",
        ...
        noises = {3},noiserandom = 0.05,dist=20,
    },
    {
        912,"Пр. Суворова",
        ...
        noises = {1,3},noiserandom = 0.4,dist=20,
    },
    {
        913,"Нахимовская",
        ...
        noises = {1,2,3},noiserandom = 0.02,dist=20,
    },
    {
        914,"Октябрьская",
        arr = {{"oktyabrskaya",3,"next_rechnaya"},{"oktyabrskaya",3,"next_nahimovskaya"}},
        dep = {{"odz1","next_rechnaya1"},{"odz2","next_nahimovskaya"}},
        noises = {1,2},noiserandom = 0.2,dist=20,
    },
    {
        915,"Речная",
        arr = {"last_rechnaya"},
        dep = {nil,{"odz2","next_oktyabrskaya"}},
        noises = {1,3},noiserandom = 0.08,dist=20,
    },
})
...
Metrostroi.AddSarmatUPOAnnouncer("UPO Artur",{
    ...
    { --МАРШРУТ
        ...
        {
            911,"Политехническая","Politehnicheskaya",
            arr = {{"politehnicheskaya",3,"next_prospekt_suvorova","spec_attention_politeness"},{"politehnicheskaya",3,"next_park_kultury","spec_attention_handrails"}},
            dep = {"next_prospekt_suvorova","next_park_kultury"},
            odz = "odz2",
        ...
        },
        {
            ...
            arrlast = {"last_rechnaya"},
            dep = {nil and "next_proletarskaya","next_oktyabrskaya"},
            odz = "odz1",
