...
ENT.SyncTable = {
    "VB","AV","VU","VU1","VU2","VU3",
    "KSD","KPVU",
    "KRZD","KDL","LOn","LOff","VozvratRP","KSN","KDP","VMK","Ring","VUS","VUD",
    "VDL","GV",
    "Headlights","DriverValveBLDisconnect","DriverValveTLDisconnect",
    "EmergencyBrakeValve"
}
ENT.SyncFunctions = {
    ""
...
function ENT:Initialize()
    ...
    self.Lights = {
        ...
        -- Cabin
        [23] = { "dynamiclight",        Vector(425,-10.0,30), Angle(0,0,0), Color(255,255,255), brightness = 0.0003, distance = 600},
        -- Interior
...
function ENT:OnButtonPress(button,ply)
    ...
    if button == "KDL" and self.VUD.Value < 1 then self.KDL:TriggerInput("Close",1) self:OnButtonPress("KDLSet") end
    if button == "KDP" and self.VUD.Value < 1 then self.KDP:TriggerInput("Close",1) self:OnButtonPress("KDPSet") end
