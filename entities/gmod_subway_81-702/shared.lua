...
ENT.Cameras = {
    ...
    {Vector(407.5+15,-24,13),Angle(35,180,0),"Train.Common.RRI"},
    {Vector(407.5+65,40,0)  ,Angle(20,180,0),"Train.Common.RouteNumber"},
    {Vector(407.5+90,0,55)   ,Angle(15,180,0),"Train.Common.LastStation"},
...
function ENT:InitializeSounds()
    ...
    self.SoundPositions["lk2_on"] = {150,1e9,Vector(-60,-40,-66),0.33}
    self.SoundPositions["lk2_off"] = {150,1e9,Vector(-60,-40,-66),0.3}
    ...
    self.SoundPositions["T"] = {330,1e9,Vector(-27,-40,-66),0.22}
    ...
    self.SoundPositions["prk1"] = {100,1e9,Vector(110,-40,-75),0.33}
    ...
    self.SoundPositions["PN1end"] = {300,1e9,Vector(-183,0,-70),0.85}
    ...
    self.SoundPositions["ring_old"] = {60,1e9,Vector(400,-40,50),0.5}
    ...
    self.SoundPositions["vpr"] = {60,1e9,Vector(431,-38.2 ,45),0.05}
    ...
    for i=0,3 do
        for k=0,1 do
            ...
            self.SoundPositions["door"..i.."x"..k.."r"] = {150,1e9,GetDoorPosition(i,k),0.55}
            self.SoundNames["door"..i.."x"..k.."o"] = {"subway_trains/d/door_open_end.wav","subway_trains/d/door_open_end2.wav"}
            self.SoundPositions["door"..i.."x"..k.."o"] = {150,1e9,GetDoorPosition(i,k),0.60}
            self.SoundNames["door"..i.."x"..k.."c"] = {"subway_trains/d/door_close_end3.wav","subway_trains/d/door_close_end.wav","subway_trains/d/door_close_end2.wav",}
            self.SoundPositions["door"..i.."x"..k.."c"] = {150,1e9,GetDoorPosition(i,k),0.90}
            self.SoundNames["door"..i.."x"..k.."so"] = {"subway_trains/d/door_open_start2.wav","subway_trains/d/door_start_open.wav"}
            self.SoundPositions["door"..i.."x"..k.."so"] = {150,1e9,GetDoorPosition(i,k),0.20}
            self.SoundNames["door"..i.."x"..k.."sc"] = {"subway_trains/d/door_close_start3.wav","subway_trains/d/door_close_start4.wav",}
            self.SoundPositions["door"..i.."x"..k.."sc"] = {150,1e9,GetDoorPosition(i,k),1}
        end
    end
...
ENT.Spawner = {
    model = {
        "models/metrostroi_train/81-702/81-702.mdl",
        "models/metrostroi_train/81-702/81-702_salon.mdl",
        "models/metrostroi_train/81-702/mirrors_d.mdl",
        "models/metrostroi_train/81-702/81-702_cabine.mdl",
        {"models/metrostroi_train/81-502/sun_protectors.mdl",pos = Vector(-2.5,-2,0)}
    },
    interim = "gmod_subway_81-702_int",
    func = function(ent,i,maxi)
        if ent:GetClass() == "gmod_subway_81-702" then
    ...
    {"SpawnMode","Spawner.Common.SpawnMode","List",{"Spawner.Common.SpawnMode.Full","Spawner.Common.SpawnMode.Deadlock","Spawner.Common.SpawnMode.NightDeadlock","Spawner.Common.SpawnMode.Depot"}, nil,function(ent,val,rot,i,wagnum,rclk)
        ...
        if ent._SpawnerStarted~=val then
            ...
            if ent.RRI  then
                ...
                ent.KU3:TriggerInput("Set",(val==1 and first) and 1 or 0)
