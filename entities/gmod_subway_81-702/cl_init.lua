...
ENT.ButtonMap["MainL"] = {
    ...
    buttons = {
        ...
        {ID = "!RedRP",         x=10,y=10, radius=10, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-703/cabin_lamp_red3.mdl",z=1,color = Color(255,160,160), var="RRP", getfunc = function(ent,min,max) return ent:GetPackedRatio("RRP") end}
        }},
        {ID = "!GreenRP",       x=40.71,y=10, radius=10, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-703/cabin_lamp_green.mdl",z=1,color = Color(140,255,255), var="GRP"}
        }},
        {ID = "!Blue",          x=73.50,y=10, radius=10, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-703/cabin_lamp_white.mdl",z=1,color = Color(160,200,255), var="SD",}
        }},
    }
}
ENT.ButtonMap["MainB"] = {
...
ENT.ButtonMap["MainP"] = {
    ...
    buttons = {
        ----Кнопки
        {   ID = "VZSet",   x=0+56*0,y=0,w=50,h=90, tooltip="", model = {
            model = "models/metrostroi_train/81-702/buttons/vu_13b.mdl", ang=Angle(-90,0,0),
            var="VZ",speed=6,
            sndvol = 1, snd = function(val) return val and "vu13a_on" or "vu13a_off" end,
            sndmin = 90, sndmax = 1e3, sndang = Angle(-90,0,0),
...
ENT.ButtonMap["Battery"] = {
    ...
    buttons = {
        ...
        --[[ {ID = "R_RadioToggle", x=130, y=314,  w=100, h=140, tooltip="", model = {
            model = "models/metrostroi_train/Equipment/vu22_black.mdl", color=Color(150,150,150), z=15, ang = 180,
            var="R_Radio",speed=6,
            sndvol = 0.8, snd = function(val) return val and "vu220b1_on" or "vu220b1_off" end,
            sndmin = 50, sndmax = 1e3, sndang = Angle(0,0,0),
        }},--]]
    }
}
...
ENT.ButtonMap["HelperPanel"] = {
    ...
    buttons = {
        ...
        {ID = "R_Program1Set",x=0, y=200,w=60,h=100, tooltip="", model = {
            model = "models/metrostroi_train/81-702/buttons/vu_13b.mdl", z=-3, ang=Angle(-90,0,0),
            labels={{model="models/metrostroi_train/81-702/labels/vu_labels.mdl",skin=7,ang=90,z=10,x=0,y=-13.5}},
            var="R_Program1",speed=6,
            sndvol = 1, snd = function(val) return val and "vu13a_on" or "vu13a_off" end,
            sndmin = 90, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "R_Program2Set",x=0, y=300,w=60,h=100, tooltip="", model = {
            model = "models/metrostroi_train/81-702/buttons/vu_13b.mdl", z=-3, ang=Angle(-90,0,0),
            labels={{model="models/metrostroi_train/81-702/labels/vu_labels.mdl",skin=8,ang=90,z=10,x=0,y=-13.5}},
...
ENT.ButtonMap["HVMeters"] = {
    ...
    buttons = {
        {ID = "!EnginesVoltage", x=0, y=0, w=55, h=55, tooltip=""},
    }
}
ENT.ButtonMap["Speedometer"] = {
    ...
    buttons = {
        {ID = "!Speedometer", x=0, y=0, w=135, h=135, tooltip=""},
    }
}
ENT.ButtonMap["BLTLPressure"] = {
    ...
    buttons = {
        {ID = "!BLTLPressure", x=60,y=60,radius=60,tooltip=""},
    }
}
ENT.ButtonMap["BCPressure"] = {
    ...
    buttons = {
        {ID = "!BCPressure", x=34,y=34,radius=34,tooltip=""},
    }
}
...
ENT.ButtonMap["UAVAPanel"] = {
    ...
    buttons = {
        ...
        {ID = "UAVAContactSet",x=60, y=0, w=120, h=170, tooltip=""},
    }
}
...
ENT.ClientProps["trafaret"] = {
    model = "models/metrostroi_train/81-702/marshrut/trafaret.mdl",
    pos = Vector(0.0,0,0),
    ang = Angle(0,0,0),
    nohide=true,
    callback = function(ent)
...
ENT.ButtonMap["LastStation"] = {
    pos = Vector(459.9+8,-20,51),
    ang = Angle(0,90,90),
    width = 644,
    height = 150,
    scale = 0.0625,
    buttons = {
        {ID = "LastStation-",x=000,y=0,w=322,h=150, tooltip=""},
        {ID = "LastStation+",x=322,y=0,w=322,h=150, tooltip=""},
    }
}

ENT.ClientProps["trafaret_l"] = {
    model = "models/metrostroi_train/81-702/marshrut/trafaret_lights.mdl",
    pos = Vector(0.0,0,0),
    ang = Angle(0,0,0),
    nohide=true,
}
...
ENT.ClientProps["trafaret_2"] = {
    model = "models/metrostroi_train/81-702/marshrut/farlight.mdl",
    pos = Vector(0.0,0,0),
    ang = Angle(0,0,0),
    hide=2,
}
...
ENT.ClientProps["RedLights"] = {
    model = "models/metrostroi_train/81-702/81-702_red_light.mdl",
    pos = Vector(470.484039,0.115477,46.430264),
    ang = Angle(0,0,0),
    nohide=true
}
...
ENT.Lights = {
    ...
    [22] = { "headlight",       Vector(450,-40.5,40.2), Angle(90,0,0), Color(255,130,88), fov=125,farz=80,brightness = 2,shadows = 1, texture = "models/metrostroi_train/equipment/headlight"},
	[23] = { "headlight",       Vector(450,-55.0,32.2), Angle(45,0,0), Color(255,130,88), fov=125, farz=65,brightness = 1,shadows = 1, texture = "models/metrostroi_train/equipment/headlight"},
}
...
function ENT:Think()
    ...
    self:ShowHideSmooth("Lamps_emer1",self:Animate("lamps_emer1",(not half2 and emer1) and 1 or 0,0,1,5,false))
    ...
    self:ShowHideSmooth("trafaret_l",HL2)
    ...
    self:HidePanel("RRIScreen",self.CurrentCamera~=6)
    ...
    local door1 = self:Animate("door1", self:GetPackedBool("FrontDoor") and 0.99 or 0,0,0.2, 8, 1)
