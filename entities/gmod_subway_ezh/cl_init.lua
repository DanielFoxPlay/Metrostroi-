...
ENT.ButtonMap["Lamps1"] = {
    ...
    buttons = {
        ----Лампы
        {ID = "!AV",        x=44.6,y=35.2, radius=20, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z = -6, ang=Angle(2,-8.5,0), color=Color(200,255,255) , var="L_AV"}
        }},
        {ID = "!SEQ",       x=44.6+27.3,y=35.2, radius=20, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z =  -6, ang=Angle(2,-8.5,0),  var="SEQ"}
        }},
        {ID = "!ARS",       x=44.6+70.7,y=35.17, radius=20, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z =  -6, ang=Angle(2,-8.5,0), var="L_ARS" }
        }},
        {ID = "!AB",        x=44.6+141.33,y=35.17, radius=20, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z =  -6, ang=Angle(2,-8.5,0), color=Color(200,255,255), var="AB" }
        }},

        {ID = "!SD",        x=231.35,y=35.18, radius=12, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z =  -6, ang=Angle(2,-8.5,0), color=Color(50,100,255), var="SD" }
        }},
        {ID = "!LSN",       x=231.5 + 27.6,y=35.18, radius=12, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z =  -6, ang=Angle(2,-8.5,0), color=Color(255,100,100),  var="LSN", getfunc = function(ent,min,max) return ent:GetPackedRatio("LSN") end}
        }},

        {ID = "!AV1",       x=59,y=74.3, radius=20, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z =  -6, ang=Angle(1,-8.5,0), color=Color(255,100,100), var="L_AV1" }
        }},
        {ID = "!RRP",       x=245.3,y=74.3, radius=20, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z =  -6, ang=Angle(1,-8.5,0), color=Color(255,100,100), var="RP"}
        }},

        {ID = "!KT", x=116.25,y=101.1, radius=12, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z =  -6, ang=Angle(1,-8.5,0), color=Color(255,255,150), var="KT"}
        }},
        {ID = "!VD", x=116.25+23.85,y=101.1, radius=12, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z =  -6, ang=Angle(1,-8.5,0), var="KVD"}
        }},
        {ID = "!RS", x=116.25+23.85*1.987,y=101.1, radius=12, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z =  -6, ang=Angle(1,-8.5,0), var="RS"}
        }},
        {ID = "!LN", x=116.25+23.85*2.945,y=101.1, radius=12, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z =  -6, ang=Angle(1,-8.5,0),  var="LN"}
        }},
...
ENT.ButtonMap["Main1"] = {
    ...
    buttons = {
        {   ID = "1:KU16Toggle",    x=45.3, y=26.8, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl",ang = Angle(-5,0,180),z=1,
            var="KU16",speed=16,
            sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {   ID = "1:ALSFreqToggle", x=69.5, y=26.8, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl",ang = Angle(-5,0,180),z=1,
            var="ALSFreq",speed=16, vmin=1, vmax=0,
            sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KVTSet",           x=246, y=11, radius=11, tooltip="", model = {
            model = "models/metrostroi_train/81-502/buttons/button_big_1.mdl", z = 0,ang=Angle(5,0,0),
        ...
        ----Lightning
        {ID = "1:KU4Set",           x=43.6, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU4",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU5Set",           x=43.6+43*1, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU5",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},

        ----Door panel
        {ID = "1:KU6KToggle",           x=43.6+43*4.5, y=185, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-707/krishka_ezh.mdl", z=13,ang=0,
            var="KU6K",speed=12, min=0.05,max=0.95,disableoff="1:KU6Set",disableon="1:KU7Set",
            ...
            sndvol = 1, snd = function(val) return val and "kr_left" or "kr_right" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU6Set",           x=43.6+43*4, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU6",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU7Set",           x=43.6+43*5, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU7",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        --{ID = "1:DoorSelectToggle",   x=43.6+43*4.5, y=180, radius=12, tooltip=""},



        {   ID = "1:ALSToggle", x=139.5, y=184.5, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl",ang = 180,z=2,
            var="ALS",speed=16,
            plomb = {model = "models/metrostroi_train/81/plomb.mdl",ang=60,x=11,y=-25,z=-2,var="ALSPl", ID="ALSPl",},
            sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {   ID = "1:ARSToggle", x=163, y=184.5, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl",ang = 180,z=2,
            var="ARS",speed=16,
            sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        ...
        {ID = "1:KU1Toggle",            x=43.6,y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU1",speed=6,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU8Set",           x=43.6+44*1,y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU8",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU9Set",           x=43.6+44*2,y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU9",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:R_Program1Set",            x=43.6+43*3+1, y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="R_Program1",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU2Toggle",            x=43.6+43*4+1, y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU2",speed=6,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "1:KU10Set",          x=43.6+43*5, y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU10",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
    }
...
ENT.ButtonMap["LampsALS1"] = {
    pos = Vector(455.1,-36,-10.35),
    ang = Angle(0,-90,0),
    width = 128,
    height = 30,
    scale = 0.0588,
    ...
    buttons = {
        ----Лампы АЛС
        {ID = "!LNF",x=15.5,y=15, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_och.mdl",z=0, var="04",  ang=90}
        }},
        {ID = "!L0",x=32,y=15, radius = 15,tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_0.mdl",z=0, var="00",  ang=90}
        }},
        {ID = "!L40",x=47,y=15, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_40.mdl",z=0, var="40",  ang=90}
        }},
        {ID = "!L60",x=69,y=15, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_60.mdl",z=0, var="60",  ang=90}
        }},
        {ID = "!L70",x=90,y=15, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_70.mdl",z=0, var="70",  ang=90}
        }},
        {ID = "!L80",x=113,y=15, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_80.mdl",z=0, var="80",  ang=90}
        }},
    }
}
---[=[
ENT.ButtonMap["Main2"] = {
    ...
    buttons = {
        {   ID = "2:KU16Toggle",    x=46, y=25.2, radius=15, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl",ang = Angle(-3,0,180),z=1,
            var="KU16",speed=16,
            sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {   ID = "2:ALSToggle", x=76.8, y=25.2, radius=15, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl",ang = Angle(-3,0,180),z=1,
            var="ALS",speed=16, vmin=0, vmax=1,
            plomb = {model = "models/metrostroi_train/81/plomb.mdl",ang=Angle(0,3,90),x=-1,y=-30,z=3,var="ALSPl", ID="ALSPl",},
            sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KVTSet",           x=240, y=25, radius=11, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_button_red.mdl",z = 4,ang=Angle(5,0,0),
            var="KVT",speed=16,vmin=1,vmax=0,
            sndvol = 0.10, snd = function(val) return val and "button1_on" or "button3_off" end,sndmin = 60, sndmax = 1e3/3, sndang = Angle(-90,0,0),
        }},
        ----Lightning
        {ID = "2:KU4Set",           x=43.6, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU4",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU5Set",           x=43.6+43*1, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU5",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        ...
        ----Door panel
        {ID = "2:KU7Set",           x=43.6+43*5, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU7",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU6Set",           x=43.6+43*4, y=180, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU6",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU6KToggle",x=43.6+43*4.5, y=183.2, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-707/krishka_ezh.mdl", z=13,ang=0,
            var="KU6K",speed=12, min=0.05,max=0.95,disableoff="2:KU6Set",disableon="2:KU7Set",
            getfunc = function(ent)
                return ent:GetPackedBool("KU6K") and (ent:GetPackedBool("KU6") and 0.8 or 1) or (ent:GetPackedBool("KU7") and 0.2 or 0)
            end,
            sndvol = 1, snd = function(val) return val and "kr_left" or "kr_right" end,
        ...
        {   ID = "2:ALSFreqToggle", x=139.5, y=183.5, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_pp250.mdl",ang = 0,z=3,
            var="ALSFreq",speed=16,
            sndvol = 1, snd = function(val) return val and "switch_on" or "switch_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {   ID = "2:ARSToggle", x=163.5, y=183.5, radius=20, tooltip="", model = {
        ...
        {ID = "2:KU1Toggle",            x=43.6,y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU1",speed=6,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU8Set",           x=43.6+44*1,y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU8",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU9Set",           x=43.6+44*2,y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU9",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:R_Program1Set",            x=43.6+43*3+1, y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="R_Program1",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU2Toggle",            x=43.6+43*4+1, y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudblack.mdl", z=-19,
            var="KU2",speed=6,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "2:KU10Set",          x=43.6+43*5, y=243, radius=20, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudwhite.mdl", z=-19, color = Color(149,95,32),
            var="KU10",speed=12, max=0.5,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0), color = Color(142,64,54),
        }},
    }
}
ENT.ButtonMap["Lamps2"] = {
    pos = Vector(457.48,-30.91,-9.19+0.17),
    ang = Angle(0,-90,8.5),
    width = 315,
    height = 120,
    scale = 0.0588,
    ...
    buttons = {
        ----Лампы
        {ID = "!RRP2",x=44.6,y=33.9, radius=20, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z = -9, ang=Angle(1,-8.5,0), color=Color(255,100,100), var="RP"}
        }},
        {ID = "!LPU2",x=44+27.8,y=33.9, radius=20, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z = -9, ang=Angle(1,-8.5,0),  var="SEQ"}
        }},

        {ID = "!VD2",x=152.15,y=99.9, radius=12, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z = -9, ang=Angle(1,-8.5,0),  var="KVD"}
        }},
        {ID = "!KT2",x=116.2,y=99.9, radius=12, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z = -9, ang=Angle(1,-8.5,0), color=Color(255,255,150), var="KT"}
        }},
        {ID = "!AB2",x=151.4+35,y=99.9, radius=12, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z = -9, ang=Angle(1,-8.5,0), color=Color(255,255,150), var="AB"}
        }},

        {ID = "!SD2",x=231.3,y=33.9, radius=12, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_green.mdl",z = -9, ang=Angle(1,-8.5,0), color=Color(50,100,255), var="SD"}
        }},
        {ID = "!LN2",x=245.3,y=72.95, radius=12, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z = -9, ang=Angle(1,-8.5,0),  var="LN"}
        }},
        {ID = "!LSN2",x=231.5 + 27.6,y=33.9, radius=12, tooltip="", model = {
            lamp = {model = "models/metrostroi_train/81-707/ezh_lamp_red.mdl",z = -9, ang=Angle(1,-8.5,0), color=Color(255,100,100),  var="LSN", getfunc = function(ent,min,max) return ent:GetPackedRatio("LSN") end}
        }},
...
---[[
ENT.ButtonMap["LampsALS2"] = {
    pos = Vector(455.1+0.9,-36,-10.35+0.15),
    ang = Angle(0,-90,0),
    width = 128,
    height = 30,
    scale = 0.0588,
    ...
    buttons = {
        ----Лампы АЛС
        {ID = "!LNF_2",x=17,y=16, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_och.mdl",z=-0.3, var="04",  ang=90}
        }},
        {ID = "!L0_2",x=32.3,y=16, radius = 15,tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_0.mdl",z=-0.3, var="00",  ang=90}
        }},
        {ID = "!L40_2",x=48.6,y=16, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_40.mdl",z=-0.3, var="40",  ang=90}
        }},
        {ID = "!L60_2",x=70.2,y=16, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_60.mdl",z=-0.3, var="60",  ang=90}
        }},
        {ID = "!L70_2",x=91,y=16, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_70.mdl",z=-0.3, var="70",  ang=90}
        }},
        {ID = "!L80_2",x=113,y=16, radius = 15, tooltip="", model = {
            lamp = {speed=16,model = "models/metrostroi_train/81-707/ezh_lamp_80.mdl",z=-0.3, var="80",  ang=90}
        }},
    }
}--]]
...
ENT.ButtonMap["VU"] = {
    ...
    buttons = {
        {ID = "VUToggle", x=0, y=0, w=92, h=110, tooltip="", model = {
        ...
        {ID = "KU14Set",            x=0, y=100, w=46, h=100, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudbrown.mdl", z=19,
            labels={{model="models/metrostroi_train/81-707/labels/vu_labels.mdl",skin=12,ang=90,z=18.9,x=0,y=-25.5}},
            var="KU14",speed=6,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
        {ID = "KU15Set",            x=46, y=100, w=46, h=100, tooltip="", model = {
            model = "models/metrostroi_train/switches/vudbrown.mdl", z=19,
            labels={{model="models/metrostroi_train/81-707/labels/vu_labels.mdl",skin=8,ang=90,z=18.9,x=0,y=-25.5}},
            var="KU15",speed=6,
            sndvol = 1, snd = function(val) return val and "vu224_on" or "vu224_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
...
ENT.ButtonMap["Stopkran"] = {
    ...
    scale = 0.1/2,
        buttons = {
            {ID = "EmergencyBrakeValveToggle",x=0, y=0, w=100, h=1300, tooltip=""},
    }
}
...
ENT.ButtonMap["AV2"] = {
    ...
    buttons = {
        {ID = "R_RadioToggle", x=2, y=0, w=100, h=136, tooltip="", model = {
            model = "models/metrostroi_train/Equipment/vu22_black.mdl", z=20, ang = 180,
            labels={{model="models/metrostroi_train/81-707/labels/vu_labels.mdl",skin=4,ang=90,z=20.9,x=0,y=-12.5}},
            var="R_Radio",speed=6,
            sndvol = 1, snd = function(val) return val and "vu22_on" or "vu22_off" end,
            sndmin = 100, sndmax = 1e3, sndang = Angle(0,0,0),
        }},
        {ID = "RSTToggle", x=120, y=0, w=100, h=136, tooltip="", model = {
            model = "models/metrostroi_train/Equipment/vu22_black.mdl", z=20, ang = 180,
        ...
        {ID = "UOSToggle",   x=253, y=37, w=40, h=40, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_pp250.mdl",ang = 180,z=-5,
            labels={{model="models/metrostroi_train/81-707/labels/vu_labels.mdl",skin=1,ang=90,z=2.5,x=0,y=-17}},
            var="UOS",speed=16,
            plomb = {model = "models/metrostroi_train/81/plomb.mdl",ang=270-50,x=-18,y=18,z=1.5,var="UOSPl", ID="UOSPl",},
            sndvol = 1, snd = function(val) return val and "switch_on" or "switch_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
    }
...
ENT.ButtonMap["KAH"] = {
    ...
    buttons = {
        {   ID = "KAHToggle",   x=0, y=0, w=40, h=40, tooltip="", model = {
            model = "models/metrostroi_train/81-710/ezh3_tumbler_pp250.mdl",ang = 180,z=-5,
            labels={{model="models/metrostroi_train/81-707/labels/vu_labels.mdl",skin=2,ang=90,z=2.5,x=0,y=-15}},
            var="KAH",speed=16,
            plomb = {model = "models/metrostroi_train/81/plomb.mdl",ang=270-50,x=-18,y=18,z=1.5,var="KAHPl", ID="KAHPl",},
            sndvol = 1, snd = function(val) return val and "switch_on" or "switch_off" end,
            sndmin=30, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
    }
...
ENT.ButtonMap["RC1"] = {
    ...
    buttons = {
        {   ID = "RC1Toggle",   x=0, y=0, w=100, h=100, tooltip="", model = {
            model = "models/metrostroi_train/81-707/rcr.mdl", ang = Angle(90,90,0), z=-17,
            var="RC1",speed=4,vmin=1,vmax=0,
            plomb = {var="RC1Pl", ID="RC1Pl",},
            sndvol = 2, snd = function(val) return val and "samm_0-2" or "samm_2-0" end,
            sndmin = 100, sndmax = 1e3, sndang = Angle(-90,0,0),
        }},
    }
}
...
ENT.ButtonMap["AB1"] = {
    ...
    buttons = {
        {ID = "AB1Set", x=0,y=0,w=40,h=50,tooltip="", model = {
...
ENT.ButtonMap["AB2"] = {
    ...
    buttons = {
        {ID = "AB2Set", x=0,y=0,w=40,h=50,tooltip="", model = {
...
ENT.ButtonMap["HVMeters"] = {
    ...
    buttons = {
        {ID = "!EnginesCurrent", x=0,y=0,w=66,h=72,tooltip=""},
        {ID = "!EnginesVoltage", x=0,y=79,w=66,h=72,tooltip=""},
    }
}
ENT.ButtonMap["Speedometer"] = {
    pos = Vector(457.7,-36.7,-5),
    ang = Angle(0,-90,86),
    width = 100,
    height = 70,
    scale = 0.0625,
    ...
    buttons = {
        {ID = "!Speedometer", x=0, y=0, w=100, h=70, tooltip=""},
    }
}

ENT.ButtonMap["BLTLPressure"] = {
    pos = Vector(458,-54.5,8.9),
...
ENT.ButtonMap["EPKDisconnect"] = {
    pos = Vector(445.35,-52.78,-30.65),
    ang = Angle(0,180+30,45),
    width = 200,
    height = 90,
    scale = 0.0625,

    buttons = {
        {ID = "EPKToggle", x=0, y=0, w=200, h=90, tooltip="", model = {
...
ENT.ClientProps["train_line"] = {
    ...
    pos = Vector(457.00,-56.9,6.54),
    ang = Angle(222,58.73,-91.6),
    hideseat = 0.2,
}
ENT.ClientProps["brake_line"] = {
    model = "models/metrostroi_train/Equipment/arrow_tm.mdl",
    pos = Vector(457.02,-56.93,6.52),
    ang = Angle(222,58.73,-91.6),
    hideseat = 0.2,
}
...
ENT.ClientProps["ampermeter"] = {
    ...
    pos = Vector(457.838257,-57.372929,24.954866),
    ang = Angle(-90.000000,-25.024040,0.000000),
...
ENT.ClientProps["voltmeter"] = {
    model = "models/metrostroi_train/81-710/ezh3_voltages.mdl",
    pos = Vector(457.800049,-57.465500,19.903502),
    ang = Angle(-90.053635,-25.024040,0.000000),
    bscale = Vector(1,1,1.3),
    hideseat = 0.2,
}
...
ENT.ClientProps["volt1"] = {
    model = "models/metrostroi_train/81-710/ezh3_voltages.mdl",
    pos = Vector(463.614563,-19.442207,1.925565),
    ang = Angle(-90,0,0),
    bscale = Vector(1,1,1.3),
    hideseat = 0.2,
}
ENT.ClientProps["speed1"] = {
    model = "models/metrostroi_train/81-710/ezh3_voltages.mdl",
    pos = Vector(458.596863,-39.826691,-9.930562),
    ang = Angle(-85,0.000000,0.000000),
...
ENT.ClientProps["salon"] = {
    model = "models/metrostroi_train/81-707/ezh_salon.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    hide = 2.0,
}
ENT.ClientProps["cabin"] = {
    model = "models/metrostroi_train/81-707/cabin.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    hide = 2.0,
}
...
ENT.ClientProps["ars_indicator"] = {
    model = "models/metrostroi_train/81-707/a_indicator.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    hide = 2.0,
}
ENT.ClientProps["controller_1"] = {
    model = "models/metrostroi_train/81-707/controller_old.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    hide = 2.0,
}
ENT.ClientProps["controller_2"] = {
    model = "models/metrostroi_train/81-707/controller_new.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    hide = 2.0,
}
...
ENT.ClientProps["Lamp_RTM"] = {
    ...
    pos = Vector(416.593567,-55.343071,10.316401),
...
ENT.ClientProps["speedo1"] = {
    ...
    pos = Vector(457.82+0.2,-40.1-0.1-0.05,-6.93-0.05),
    ang = Angle(90-6,180,0),
    color = Color(250,200,70),
    hideseat = 0.2,
}
ENT.ClientProps["speedo2"] = {
    model = "models/metrostroi_train/81-717/segments/segment_spb.mdl",
    pos = Vector(457.82+0.2,-40.1+0.89-0.1+0.05,-6.93-0.05),
    ang = Angle(90-6,180,0),
    color = Color(250,200,70),
    hideseat = 0.2,
}
...
ENT.Lights = {
    ...
    [22] = { "headlight",       Vector(445,-55,41), Angle(75, 70,45), Color(190, 130, 88), fov=135, farz=90, brightness = 1.5, shadows = 1, texture = "models/metrostroi_train/equipment/headlight"},
    [23] = { "headlight",       Vector(445,-55.0,32.2), Angle(0,0,0), Color(255,130,88), fov=125, farz=65,brightness = 1.5,shadows = 0, texture = "models/metrostroi_train/equipment/headlight"},
    --[24] = { "headlight",       Vector(442,-53.0,-0.2), Angle(75,0,0), Color(255,130,88), fov=90, farz=65,brightness = 2,shadows = 0},
    [40] = { "headlight",       Vector(457.80,-37.3,-5.3),Angle(45,-40,120) , Color(255,125,25), farz = 6, nearz = 1, shadows = 0, brightness = 16, fov = 80},
    [41] = { "headlight",       Vector(457.80,-42.6,-5.3),Angle(45,40,120) , Color(255,125,25), farz = 6, nearz = 1, shadows = 0, brightness = 16, fov = 80},
}
...
function ENT:Think()
    ...
    local typ = self:GetNW2Int("TrainType",1)
    self:HidePanel("Main1",typ~=1)
    self:HidePanel("Lamps1",typ~=1)
    self:HidePanel("LampsALS1",typ~=1)
    self:HidePanel("RRI",typ~=1)
    self:HidePanel("RRIScreen",typ~=1 or self.CurrentCamera ~= 9)
    self:ShowHide("controller_1",typ==1)
    self:ShowHide("speed1",typ==1)
    self:ShowHide("E_informator",typ==1)


    self:ShowHide("R_RadioToggle",typ==2)
    self:ShowHide("R_RadioToggle_label1",typ==2)
    self:HidePanel("Main2",typ~=2)
    self:HidePanel("Lamps2",typ~=2)
    self:HidePanel("LampsALS2",typ~=2)
    ...
    self:ShowHide("controller_2",typ==2)

    local speed = self:GetPackedRatio("Speed")*100.0
    self:ShowHide("speedo1",typ==2 and self:GetPackedBool("V1"))
    self:ShowHide("speedo2",typ==2 and self:GetPackedBool("V1") and speed >= 10)
    ...
    self:SetLightPower(40,typ==1 and IsValid(self.ClientEnts.Lamps_pult) and PL>0,PL)
    self:SetLightPower(41,typ==1 and IsValid(self.ClientEnts.Lamps_pult) and PL>0,PL)
    ...
    self:Animate("krureverser",self:GetPackedRatio("KRUPosition"),0.61,1,3,false)
    self:Animate("volt1", self:GetPackedRatio("BatteryVoltage"),0.622+0.01,0.382-0.01,45,3)
    ...
    ---Animate brakes
    self:Animate("brake_line",self:GetPackedRatio("BLPressure"),0, 0.748,  256,2)--,,0.01)
    self:Animate("train_line",self:GetPackedRatio("TLPressure"),0, 0.748,  4096,2)--,,0.01)
    ...
    self:Animate("speed1", self:GetPackedRatio("Speed"),0.630 ,0.370, nil, nil,  90,200,20)
