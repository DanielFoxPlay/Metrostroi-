...
function ENT:Initialize()
    ...
    self.Lights = {
        [9] = { "dynamiclight",    Vector(200, 0, -5), Angle(0,0,0), Color(219,66*2,31*1.5), brightness = 3, distance = 200},
        [10] = { "dynamiclight",    Vector(-150, 0, -5), Angle(0,0,0), Color(219,66*2,31*1.5), brightness = 3, distance = 200},
