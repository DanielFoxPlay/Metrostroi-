...
ENT.Lights = {
    ...
    --cabinlight
    [22] = { "headlight",       Vector(432+18.5,-33.5,47.2), Angle(90,0,0), Color(240,230,255), farz = 200, nearz = 0.1, shadows = 0,  brightness = 0.3, fov = 160, texture = "models/metrostroi_train/equipment/headlight"},
}
